...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Yunfeng', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kang.ink', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'notion,blog,博客,Cloudwind, Kang,云风,雲風,纳瓦尔,投资,付鹏,高善文,赌博,芒格,说话,投机,加密,修道,AI,学佛,戒赌,修道,行道,修心,大选择,选择,人工智能,极速建站,段永平,李国飞,老喻,决策,决策算法,道教,道家,黄帝内经,行道修心,戒色,道场', // 网站关键词 英文逗号隔开
