...
function isCacheEnabled() {
  if (typeof BLOG.ENABLE_CACHE === 'boolean') {
    return BLOG.ENABLE_CACHE
  }

  if (typeof BLOG.ENABLE_CACHE === 'string') {
    return BLOG.ENABLE_CACHE.toLowerCase() !== 'false'
  }

  return Boolean(BLOG.ENABLE_CACHE)
}
...
export async function getDataFromCache(key, force) {
  if (!isCacheEnabled() && !force) return null
